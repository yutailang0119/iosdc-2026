  ...
  var body: some View {
    ZStack {
      ...
      case .dora, .silent:
        ...
        .foregroundStyle(phase.expressionStyle)
      }
      CenteringLayout {
        VStack(spacing: 8) {
          Text("Enjoy Bytebeat")
        ...
        .foregroundStyle(phase.messageStyle)
      }
    }
...
private extension ImprintSlide.SlidePhasedState {
  ...
  var messageStyle: HierarchicalShapeStyle {
    switch self {
    case .initial, .silent: .primary
    case .dora: .tertiary
    }
  }

  var expressionStyle: HierarchicalShapeStyle {
    switch self {
    case .initial, .silent: .tertiary
    case .dora: .primary
    }
  }
}
